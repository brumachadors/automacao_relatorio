...
for raster in input_raster_list:
    ...
    value_range = RemapRange([[0, 255, 99]])
    reclass = Reclassify(raster, "VALUE", value_range)
    arcpy.conversion.RasterToPolygon(reclass, tmp_bbox_out, "SIMPLIFY", "VALUE")
